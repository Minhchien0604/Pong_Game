...
public class Window extends JFrame implements Runnable {
    ...
    public Rect playOne, ai, ballRect;
    public PlayerController playerController;
    public AIController aiController;
    public Ball ball;
    public Text leftSocreText, rightScoreText;
    ...
    public Window (){
        ...
        leftSocreText = new Text(0, new Font("Times New Roman", Font.PLAIN, Constants.TEXT_SIZE),Constants.TEXT_X_POS,Constants.TEXT_Y_POS);
        ...
        playOne = new Rect(Constants.HZ_PADDING,40,Constants.PADDLE_WIDTH,Constants.PADDLE_HEIGHT, Constants.PADDLE_COLOR);
        ...
        ball = new Ball (ballRect, playOne, ai,leftSocreText,rightScoreText);
